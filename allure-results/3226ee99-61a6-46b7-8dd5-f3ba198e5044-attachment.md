...
Expected: "Automation Exercise - Signup / Logi"
...
> 6 |     await expect(page).toHaveTitle("Automation Exercise - Signup / Logi");
    |                        ^ Error: expect(page).toHaveTitle(expected) failed
  7 |     await page.pause(2000);
  8 | }    
  9 | )
```