...
Locator: .#header-inner > div.descriptionwrapper > p > span
...
> 15 |     await expect(page.locator('.#header-inner > div.descriptionwrapper > p > span')).toHaveText();
     |                                                                                      ^ Error: expect(locator).toHaveText(expected) failed
