...
```
TypeError: Cannot read properties of undefined (reading 'sheet_to_json')
```
    ...
    - generic [ref=e68]:
      ...
      - insertion [ref=e73]:
        - generic [ref=e76]:
          ...
          - link "Download Reference Apps" [ref=e79] [cursor=pointer]
          - link "Download Productivity Apps" [ref=e84] [cursor=pointer]
          - link "Learn Coding Online" [ref=e89] [cursor=pointer]
  - text: 
```
...
> 10 |     const data=sheet.utils.sheet_to_json();
     |                            ^ TypeError: Cannot read properties of undefined (reading 'sheet_to_json')
  11 | 
