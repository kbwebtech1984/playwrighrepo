...
- Name: demotest.spec.js >> launchbrowser
- Location: tests\demotest.spec.js:3:5

# Error details

```
Error: locator.fill: Error: Role must not be empty
    at Object.queryAll (<anonymous>:5321:15)
...
Call log:
  - waiting for getByRole('', { ng-model: 'FirstName' })
    ...
    - generic [ref=e44]:
      - insertion [ref=e46]:
        - generic [ref=e49]:
          ...
          - link "Setup Email Hosting" [ref=e52] [cursor=pointer]
          - link "Website hosting plans" [ref=e57] [cursor=pointer]
          - link "Compare Developer Tools" [ref=e62] [cursor=pointer]
          - link "Training materials" [ref=e67] [cursor=pointer]
          - link "Download Productivity Apps" [ref=e72] [cursor=pointer]
          - link "Performance testing services" [ref=e77] [cursor=pointer]
          - link "Automation testing tools" [ref=e82] [cursor=pointer]
