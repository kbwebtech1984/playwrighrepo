...
- generic [active] [ref=e1]:
  ...
  - insertion [ref=e73]:
    - generic [ref=e76]:
      ...
      - link "Install Firewall Software" [ref=e79] [cursor=pointer]
      - link "Compare Developer Tools" [ref=e84] [cursor=pointer]
...
```ts
  ...
  7  |     const title1 = await expect(page).toHaveTitle("Automation Exercise - Signup / Login");
> 8  |     if (title=title1)
     |              ^ TypeError: Assignment to constant variable.
  9  |     {
