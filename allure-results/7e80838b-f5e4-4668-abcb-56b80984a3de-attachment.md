...
- generic [ref=e1]:
  ...
  - generic [ref=e39]:
    - generic [ref=e41]:
      ...
      - generic [ref=e43]:
        - textbox "Email Address" [ref=e44]: kunal@test.com
        - textbox "Password" [active] [ref=e45]: "123456"
  ...
  - insertion [ref=e73]:
    - generic [ref=e76]:
      ...
      - link "Software testing resources" [ref=e79] [cursor=pointer]
      - link "TV & Video Equipment" [ref=e84] [cursor=pointer]
...
```ts
  ...
  16 |         await page.fill('//*[@id="form"]/div/div/div[1]/div/form/input[3]',data[i].password.toString());
