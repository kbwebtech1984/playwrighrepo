...
```
ReferenceError: sheet1 is not defined
```
...
- generic [active] [ref=e1]:
  ...
  - insertion [ref=e73]:
    - generic [ref=e76]:
      ...
      - link "TV & Video" [ref=e79] [cursor=pointer]
...
> 9  |     const sheet=workbook.Sheets[sheet1];
  ...
  13 |     {
  14 |         await page.fill('//*[@id="form"]/div/div/div[1]/div/form/input[2]',data[i].username)
  15 |         await page.fill('//*[@id="form"]/div/div/div[1]/div/form/input[3]',data[i].password)
  16 |         await page.getByText('Login').click();
  17 |     }
  18 |     
  19 | });
```